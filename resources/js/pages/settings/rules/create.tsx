...
export default function AlertRuleCreate({ site, devices }: Props) {
    const { t } = useLang();
    ...
    function addCondition() {
        form.setData('conditions', [...form.data.conditions, { ...EMPTY_CONDITION }]);
    }
                            ...
                            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                                <div className="sm:col-span-2 lg:col-span-3">
                                    ...
                                    <Input
                                        ...
                                        placeholder={t('e.g., Walk-in Cooler Max Temperature')}
                                        required
                                    />
                                    {form.errors.name && (
                                ...
                                <div className="sm:col-span-2 lg:col-span-3">
                                    ...
                                    >
                                        <SelectTrigger className="mt-1.5">
                                            <SelectValue placeholder={t('All devices at this site')} />
                                        </SelectTrigger>
                                        <SelectContent>
                    ...
                    <FadeIn delay={225} duration={400}>
                        <div className="flex items-center justify-end gap-3 border-t pt-6">
                            ...
                            <Button type="submit" disabled={form.processing}>
                                ...
                                {form.processing ? t('Creating...') : t('Create Rule')}
                            </Button>
                        </div>
                    </FadeIn>
                </form>
