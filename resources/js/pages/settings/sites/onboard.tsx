                ...
                <FadeIn direction="down" duration={400}>
                    <div className="relative overflow-hidden rounded-xl border border-border/50 bg-card shadow-elevation-1">
                        ...
                        <div className="relative p-6 md:p-8">
                            ...
                            <Stepper currentStep={activeStep} steps={wizardSteps} className="px-4 pb-2" />
                        </div>
                    </div>
                </FadeIn>
...
function ChirpStackWarningBanner() {
    ...
    return (
        <Card className="border-amber-200 bg-amber-50/50 shadow-elevation-1 dark:border-amber-900 dark:bg-amber-950/30">
...
function SegmentSuggestionBanner({ suggestions }: { suggestions: SegmentSuggestions }) {
    ...
    return (
        <Card className="border-blue-200 bg-blue-50/50 shadow-elevation-1 dark:border-blue-900 dark:bg-blue-950/30">
            <CardContent className="flex items-start gap-4 py-4">
            ...
            <FadeIn delay={100} duration={400}>
                <Card className="shadow-elevation-1">
                    <CardHeader>
                        ...
                        <CardDescription>
                            <span className="font-mono tabular-nums">{gateways.length}</span> {t('gateway(s) registered')}
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        {gateways.length === 0 ? (
            ...
            {devices.length > 0 && (
                <FadeIn delay={50} duration={400}>
                    <Card className="shadow-elevation-1">
                        <CardHeader>
                            <CardTitle>
                                {t('Registered Devices')} (<span className="font-mono tabular-nums">{devices.length}</span>)
                            </CardTitle>
                        </CardHeader>
                        <CardContent>
                            <Table>
                                ...
                                <TableBody>
                                    {devices.map((device) => (
                                        <TableRow key={device.id}>
                                            ...
                                            <TableCell className="font-mono tabular-nums text-xs">{device.dev_eui}</TableCell>
                                ...
                                {newDevices.map((device, idx) => (
                                    ...
                                    >
                                        ...
                                        <div>
                                            ...
                                            <Input
                                                className="mt-1 font-mono tabular-nums text-xs"
            ...
            <FadeIn delay={100} duration={400}>
                <Card className="shadow-elevation-1">
                    <CardHeader>
                        ...
                        <CardDescription>
                            <span className="font-mono tabular-nums">{floorPlans.length}</span> {t('floor plan(s) uploaded')}
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        {floorPlans.length === 0 ? (
...
function CompleteStep({
    ...
    return (
        <FadeIn delay={50} duration={400}>
            <Card className="mx-auto max-w-lg shadow-elevation-1">
